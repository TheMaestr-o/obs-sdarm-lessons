...
| 3 | infor-r Lower Thirds | BroadcastChannel panel (`panel.html` → `result.html`), or raw URL params | ✅ fully (after localizing paths) | short: two lines, animated CodePen design; 3 named styles (Slash & Slide, Slide Up / Down, Framed Reveal), always bottom-anchored |
